...
WINE_PAIRINGS: dict[str, dict] = {
    ...
    "Nederburg Cabernet Sauvignon": {
        ...
        "keywords": ["beef", "tomahawk", "fillet", "steak", "rump", "biftekia"],
        "price": 125,
    ...
    "Porcupine Ridge Shiraz": {
        ...
        "keywords": ["lamb", "chops", "souvlaki", "kleftiko"],
        "price": 140,
    ...
    "KWV Roodeberg Red Blend": {
        ...
        "keywords": ["meatball", "keftethes", "soutzoukakia", "grilled meat"],
        "price": 199,
        "reason": "Spicy notes match Greek meatballs and seasoned meats",
    },
    "Simonsig Cap Classique": {
        "name": "Simonsig Kaapse Vonkel Brut Cap Classique",
        "flavor_profile": "brioche, citrus, bubbles",
        "keywords": ["meze", "appetizer", "starter", "saganaki"],
        "price": 220,
        "reason": "Bubbles and acidity pair elegantly with meze plates",
    },
    "Fairview Pinotage": {
        ...
        "price": 130,
        "reason": "Earthy notes complement Greek herbs and olive oil",
    },
}
...
class RecommenderV2:
    ...
    def __init__(self, menu_path: str = "food/MythosMenu.json",
