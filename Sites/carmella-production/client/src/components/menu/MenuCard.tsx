...
import { Plus, Sparkles, Percent, Tag } from 'lucide-react';
...
interface MenuCardProps {
  ...
  // STEP 5 — set when this item is inside an active Special. Takes priority
  // over the Happy Hour discount display if both somehow apply — a curated
  // Special price is deliberate, a Happy Hour window is a blanket rule.
  specialPrice?: number;
}

export const MenuCard = memo(function MenuCard({ item, onAddToCart, onClick, happyHourDiscountPct, specialPrice }: MenuCardProps) {
  ...
  return (
    ...
    >
      <div className={styles.imageWrap}>
        ...
        {!soldOut && specialPrice != null ? (
          <span className={styles.chipHappyHour} aria-label="Special">
            <Tag size={10} /> Special
          </span>
