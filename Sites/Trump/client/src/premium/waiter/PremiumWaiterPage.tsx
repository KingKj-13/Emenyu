...
import './premium-waiter-theme.css';
import './premium-waiter-v2.css';
...
import { StartShiftScreen } from './PremiumStartShiftScreen';
import { SplitBillModal } from './PremiumSplitBillModal';
...
export function PremiumWaiterPage() {
  useHomeBackGuard();
  return (
