...
import styles from './PremiumKitchenPage.module.css';
...
export function PremiumKitchenPage() {
  useHomeBackGuard();
  ...
  async function loadOrders() {
    ...
    } catch { /* keep the last known board on a failed refresh */ }
    setLoading(false);
  }
  ...
  async function advance(order: KitchenOrder) {
    ...
    } catch { /* socket kitchenStatusUpdate reconciles the board either way */ }
  }
