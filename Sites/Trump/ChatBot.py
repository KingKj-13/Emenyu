"""
🇬🇷 JOSH 10.0 - TRUMP PRIME GRILLHOUSE AI CONCIERGE (INTERACTIVE & CONVERSATIONAL)
=====================================================================================
Production-ready Flask chatbot with:
✅ CONVERSATIONAL AI - talks like a real grillhouse waiter, not a bot
...
✅ Friendly grillhouse waiter personality with natural dialogue
✅ Session-based conversation memory
✅ Dietary/allergy filtering (INCLUDING VEGAN!)
✅ Smart fallback recommendations
✅ Admin learning system

Author: Josh | Restaurant: Trump Prime Grillhouse
...
MENU_FILE = os.path.join(FOOD_DIR, "TrumpMenu.json")
    ...
    def __init__(self):
        self.wines = {
            ...
            "KWV Roodeberg Red Blend": {
                ...
                "avoid": ["delicate fish"],
                "price": 199,
                "reason": "Spice notes match charred beef and seasoned meats"
            },
            ...
            "Fairview Pinotage": {
                ...
                "weight": "medium-full",
                "acidity": "high",
                "pairs_with": ["chicken", "beef", "lamb", "grillhouse flavours"],
                "avoid": ["delicate seafood"],
                "price": 130,
                "reason": "Earthy notes match char, mushrooms and premium beef"
            },
            ...
            "Heineken": {
                ...
                "avoid": ["none"],
                "price": 28,
                "reason": "Classic pairing with flame-grilled proteins"
            }
        }
...
class KnowledgeEngine:
    """Search Wikipedia for steakhouse, butchery, wine and hospitality facts."""
    
    def __init__(self):
        self.greece_keywords = [
            'steak', 'butchery', 'beef', 'grill', 'wine', 'cellar',
            'cocktail', 'biltong', 'charcoal', 'dry aged', 'hospitality', 'sommelier',
    ...
    def search_wikipedia(self, query):
        """Return local knowledge for compatibility with the older chatbot flow."""
        query_lower = query.lower()
        local_facts = [
            (['tomahawk', 'ribeye', 'bone'], 'Tomahawk steak', 'A tomahawk is a bone-in ribeye cut with dramatic presentation and rich marbling.'),
            (['wagyu', 'marbling'], 'Wagyu beef', 'Wagyu is prized for fine intramuscular marbling and a buttery finish.'),
            (['pinotage', 'shiraz', 'cabernet', 'wine'], 'Steakhouse wine pairing', 'Structured reds balance grilled beef because tannin and dark fruit cut through char and fat.'),
            (['biltong'], 'Biltong', 'Biltong is cured, air-dried meat seasoned with spice and vinegar.'),
            (['sushi', 'salmon', 'prawn'], 'Seafood ordering', 'Seafood and sushi pair well with crisp whites, sparkling wine, citrus, and lighter cocktails.')
        ]
        for terms, title, extract in local_facts:
            if any(term in query_lower for term in terms):
                return {'title': title, 'snippet': extract, 'extract': extract, 'found': True}
        return {'found': False, 'error': 'Could not find local information'}
        try:
            search_url = "local-disabled"
            params = {
                'action': 'query',
                'list': 'search',
                'srsearch': query,
...
# ==============================================================================
class ConversationalGrillhousePersonality:
    """REAL conversations, not bot-like responses."""
    
    def __init__(self):
        self.greetings = [
            "Welcome to Trump Prime Grillhouse. How can I help tonight?",
            "Kalimera! The kitchen is buzzing today. What brings you in?",
            "Welcome, welcome. First time with us or are you a regular?",
            ...
            "Welcome. Ready for premium cuts, grillhouse dining or the cellar?",
        ...
        self.food_questions = [
            ...
            "First time with us, or do you already know your favourite cut?",
        ]
        ...
        self.confirmations = [
            ...
            "Excellent. You know your way around a grillhouse.",
        ]
...
personality = ConversationalGrillhousePersonality()
...
class RecommenderEngine:
    ...
    def load_menu(self):
        ...
        try:
            ...
            self.all_items = flat
            self.calc_popular()
            print(f"✅ Loaded {len(flat)} Trump Prime menu items!")
            return True
...
def chat():
    ...
    try:
        ...
        greeting_words = ["hi", "hello", "hey", "hiya", "sup", "yo", "greetings", "howdy"]
        ...
        if any(x in msg for x in ["vegan", "i am vegan", "im vegan", "i'm vegan"]):
            ...
            if vegan_items:
                ...
                return jsonify({"reply": "I'm so sorry, but we don't currently have fully vegan options on our menu. This grillhouse menu leans heavily on meat, dairy and the cellar. Would you like to see vegetarian options or dishes we can modify?"})
        ...
        if any(x in msg for x in ["in food", "food special", "food menu", "signature", "grillhouse", "steakhouse"]):
            ...
            if food_only:
                reply = "You want the signature grillhouse experience? Here are our specialties:\n"
...
if __name__ == '__main__':
    print("=" * 80)
    print("🇬🇷 JOSH 10.0 - TRUMP PRIME AI CONCIERGE (CONVERSATIONAL & INTERACTIVE) 🇬🇷")
    print("=" * 80)
    print("Features:")
    ...
    print("  ✅ Friendly Grillhouse Waiter Personality")
