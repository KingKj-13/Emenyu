...
====================
Run ONCE to download the bilingual ↔ English language packs
...
print("📦 Installing argostranslate bilingual ↔ English language packs...")
...
try:
    ...
    print("🎉 Offline bilingual ↔ English translation is ready!\n")
