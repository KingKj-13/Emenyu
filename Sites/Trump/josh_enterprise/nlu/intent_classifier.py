...
INTENT_PATTERNS: dict[str, list[str]] = {
    "greet":             ["hi", "hello", "hey", "howdy", "good morning", "good evening"],
    ...
    "knowledge_query":   ["what is steakhouse", "history", "origin of", "culture",
                          "traditional", "authentic", "butchery", "wine cellar"],
