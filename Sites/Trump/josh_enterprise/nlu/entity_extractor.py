...
Extracts:
  ...
  CUISINE              steakhouse, grillhouse, butchery ...
...
FOOD_PATTERNS = [
    # proteins
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["beef", "steak", "tomahawk", "fillet", "rump", "rib"]}}]},
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["lamb", "chops", "rosemary"]}}]},
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["chicken", "poultry"]}}]},
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["pork", "cutlet"]}}]},
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["seafood", "fish", "prawn", "shrimp", "calamari",
                                                          "squid", "mussel", "oyster", "hake", "sole", "sardine",
                                                          "kingklip", "octopus"]}}]},
    # starters / dishes
    {"label": "FOOD_TYPE", "pattern": [{"LOWER": {"IN": ["biltong", "charcuterie", "butchery", "starter",
                                                          "mushroom", "oyster", "prawns", "chips",
                                                          "cheesecake", "dessert", "skillet"]}}]},
    # plant
...
DRINK_PATTERNS = [
    ...
    {"label": "DRINK_TYPE", "pattern": [{"LOWER": {"IN": ["whisky", "whiskey", "bourbon", "single malt"]}}]},
]

CUISINE_PATTERNS = [
    {"label": "CUISINE", "pattern": [{"LOWER": {"IN": ["steakhouse", "grillhouse", "butchery", "cellar"]}}]},
]
...
FOOD_ALIASES: dict[str, str] = {
    ...
    "rib": "beef", "biltong": "beef",
    "chops": "lamb", "rosemary": "lamb",
    "poultry": "chicken",
