"""
Response Generator - Premium Grillhouse Personality
==============================================
...
from dialogue.grillhouse_templates import pick as tpick, get_pool
...
GREET_POOL = [
    ...
    "Welcome in. What are you in the mood for tonight?",
]
...
ASK_PREFERENCE_POOL = [
    ...
    "First time with us or do you already know your favourite cut? I'll tailor my suggestions.",
]
...
CONFIRM_POOL = [
    ...
    "That is a proper grillhouse choice.",
]
...
SMALL_TALK_POOL = [
    "I'm Josh, your grillhouse concierge. I know the cuts, the sauces and the cellar pairings.",
    "I'm doing wonderfully, thank you. Even better now that the grill is moving.",
    "I love chatting, but my real skill is finding you the perfect plate. Try me.",
]
