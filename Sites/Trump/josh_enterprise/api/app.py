...
PROJECT_ROOT = os.path.dirname(JOSH_ROOT)                   # Trump/             <- food/TrumpMenu.json lives here

sys.path.insert(0, JOSH_ROOT)   # so 'from nlu import ...' works
os.chdir(PROJECT_ROOT)          # so 'food/TrumpMenu.json' resolves
...
if __name__ == "__main__":
    print("=" * 70)
    print("JOSH 11.0 - Trump Prime Grillhouse AI (NLU Edition)")
    print("=" * 70)
    ...
    if recommender.load():
        ...
        print("Cannot start: TrumpMenu.json not found.")
        print("   Place it at: food/TrumpMenu.json")
