// Phase 03 staff-operations types. SHARED CONTRACT — kept identical to the web
// client's `client/src/types/operations.ts` so both UIs consume the same server
// shapes. Do not diverge these without changing the server response.
